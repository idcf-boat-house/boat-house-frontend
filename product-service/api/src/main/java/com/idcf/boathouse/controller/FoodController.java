...
public class FoodController extends BaseController {
	...
	@ResponseBody
	@ApiOperation("添加菜品")
	public Map<String, Object> addFood(@RequestParam(value = "菜品分类ID") Integer categoryId,
	...
	@ResponseBody
	@ApiOperation("更新菜品")
	public Map<String, Object> addFood(@RequestParam(value = "菜品ID") Integer id,
			@RequestParam(value = "菜品分类ID") Integer categoryId, @RequestParam(value = "菜品名称") String name,
